...
\begin{align*}
  ...
  \text{\texttt{SENDM1}} = &((\text{getout!m} \then (\text{nprio} \then \text{\texttt{ROBOT\_MOV}})) \extchoice \text{getout?m} \then \text{\texttt{RESPONDM}}) \\
  \text{\texttt{SENDR1}} = &((\text{getout!m} \then (\text{nprio} \then \text{\texttt{ROBOT\_REACH}})) \extchoice \text{getout?m} \then \text{\texttt{RESPONDR}}) \\
...
SENDM1 = ((getout!2 -> (nprio -> ROBOT_MOV1)) 
          [] getout?1 -> RESPONDM1)
SENDR1 = ((getout!2 -> (nprio -> ROBOT_REACH1)) 
          [] getout?1 -> RESPONDR1)
